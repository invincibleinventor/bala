...
<div className={`mx-auto flex flex-col ${path=='/' || path.includes('/main')?'border-l-2 border-l-blue-400':'border-l-2 border-l-neutral-800'}`}>
      <Link href={a} onClick={()=>{if(path=='/' || path.includes('/main'))setFile(!file)}} className="flex content-center items-center p-4">
    ...
    <div className={`mx-auto flex flex-col ${path=='/search'?'border-l-2 border-l-blue-400':'border-l-2 border-l-neutral-800'}`}>
        ...
        <Link href="/search" className="flex content-center items-center p-4">
      ...
      <div className={`mx-auto flex flex-col ${path=='/git'?'border-l-2 border-l-blue-400':'border-l-2 border-l-neutral-800'}`}>
        ...
        <Link href="/git" className="flex content-center items-center p-4">
      ...
      <div className={`mx-auto flex flex-col ${path=='/projects'?'border-l-2 border-l-blue-400':'border-l-2 border-l-neutral-800'}`}>
        ...
        <Link href="/projects" className="flex content-center items-center p-4">
      ...
      <div className={`mx-auto flex flex-col ${path=='/contact'?'border-l-2 border-l-blue-400':'border-l-2 border-l-neutral-800'}`}>
        ...
        <Link href="/contact" className="flex content-center items-center p-4">
    ...
    <header className={`flex h-[calc(100vh-48px)] w-48 flex-col content-center items-center border-r border-r-[#121212] bg-neutral-900 p-0 ${file?'':'hidden'}`}>
          ...
          <div className="flex w-48 cursor-pointer flex-row content-center items-center space-x-0 p-1 pt-2" onClick={()=>setExpanded(!expanded)}>
           ...
           <div className={`flex flex-col space-y-1 ${expanded?'':'hidden'}`}>
            <Link href="/" className={`flex w-48 shrink-0 flex-row content-center items-center space-x-1 bg-neutral-900  py-1  text-sm text-neutral-300 ${!(path).includes('/main') && !(paths.includes(path))?'neut-800  text-neutral-200':''}`}>
          ...
          <iconify-icon class="text-2xl text-blue-400" icon="clarity:code-line"></iconify-icon>
            ...
            <Link href="/main/languages" className={`flex w-48 shrink-0 flex-row content-center items-center space-x-1 bg-neutral-900  py-1  text-sm text-neutral-300 ${path=='/main/languages'?'neut-800  text-neutral-200':''}`}>
            <div className="ml-3 mr-auto flex flex-row content-center items-center space-x-1">
          <iconify-icon class="text-2xl text-blue-400" icon="clarity:code-line"></iconify-icon>
          ...
          <iconify-icon class="text-2xl text-blue-400" icon="clarity:code-line"></iconify-icon>
            ...
            <Link href="/main/testimonials" className={`flex w-48 shrink-0 flex-row content-center items-center space-x-1 bg-neutral-900  py-1  text-sm text-neutral-300 ${path=='/main/testimonials'?'neut-800  text-neutral-200':''}`}>
            <div className="ml-3 mr-auto flex flex-row content-center items-center space-x-1">
          <iconify-icon class="text-2xl text-blue-400" icon="clarity:code-line"></iconify-icon>
